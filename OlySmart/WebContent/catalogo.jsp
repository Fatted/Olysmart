...
String trovaBarra=request.getParameter("search");			//prendiamo ciÃ² che cerca l'utente
...
//se la barra laterale non Ã¨ stata selezionata ma l'utente ha scritto nella barra di ricerca
if(trovaBarra!=null && trovacategoria==null && trovaMarca==null){
	trovabarra=trovaBarra;
	prodotti=prod.getAllProductsForNome(trovabarra);//la lista dei prodotti sarÃ  selezionata per nome 
	...
	prodotti=prod.getAllProductsForCategory(trova);	//la lista dei prodotti sarÃ  formata dai prodotti con la categoria selezionata
}else if(!trovacategoria.equals("all") && trovaMarca!=null){ //se trovacategoria Ã¨ diversa da all e trovamarca non Ã¨ nulla
	trova=trovacategoria;
...
//controllo del cliente se Ã¨ loggato o meno
